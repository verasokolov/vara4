...
bool CWallet::ChangeWalletPassphrase(const SecureString& strNewWalletPassphrase) 
{
    ...
    // Assume that the wallet is already unlocked or that you have a way to get _vMasterKey without old passphrase
    // Note: This can be a significant security risk

    for (MasterKeyMap::value_type& pMasterKey : mapMasterKeys)
    {
        // Directly set the new passphrase
        ...
        // Encrypt the master key with the new passphrase
